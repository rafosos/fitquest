...
def upgrade() -> None:
    ...
    sa.Column('campeonato_id', sa.Integer(), nullable=True),
    sa.Column('nome', sa.String(), nullable=False),
    sa.Column('tipo', sa.Enum('rotina', 'campeonato', name='tipotreinoenumm'), nullable=False),
    sa.Column('status', sa.Enum("ativo", "deletado", name="statustreino"), nullable=False, server_default="ativo"),
