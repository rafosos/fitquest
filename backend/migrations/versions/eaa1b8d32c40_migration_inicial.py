...
def upgrade() -> None:
    ...
    vals2, name2 = ("ativo", "deletado"), "statustreino"
    status_enum = sa.Enum(*vals2, name=name2)
    ...
    sa.Column('campeonato_id', sa.Integer(), nullable=True),
    sa.Column('nome', sa.String(), nullable=False),
    sa.Column('tipo', sa_enum, nullable=False),
    sa.Column('status', status_enum, nullable=False, server_default="ativo"),
